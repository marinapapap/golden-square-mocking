RSpec.describe "doubles" do
  ...
  it "creates a double for a specific case" do
    ...
    # count_1 = allow(fake_diary).to receive(:add).with(double :diary_entry).and_return(1)
    # count_2 = allow(fake_diary).to receive(:add).with(double :diary_entry).and_return(1)
